...
#define printf_log(L, ...) WINE_ERR(__VA_ARGS__)
#define printf_log_prefix(prefix, L, ...) WINE_ERR(__VA_ARGS__)
#define dynarec_log(L, ...) WINE_ERR(__VA_ARGS__)
#define dynarec_log_prefix(prefix, L, ...) WINE_ERR(__VA_ARGS__)
#else
...
#endif
#ifdef _WIN32
extern void *box_malloc(size_t size);
extern void *box_realloc(void *ptr, size_t size);
extern void *box_calloc(size_t nmemb, size_t size);
extern void  box_free(void *ptr);
extern void *box_memalign(size_t alignment, size_t size);
#else
